...
class _AssetInheritorsPageState extends State<AssetInheritorsPage> {
  ...
  Future<void> _add() async {
    ...
    if (available.isEmpty) {
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(SnackBar(content: Text(L10n.tr('暂无可用继承人(请先在继承人管理中创建)'))));
      return;
    }
      ...
      appBar: AppBar(
        title: Text(
          _multiSelect
              ...
              : L10n.trp('资产继承人 · {name}', {'name': widget.assetName}),
        ),
              ...
              : ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return ListTile(
                      ...
                      title: Text(
                        '${b['inheritor_name'] ?? L10n.trp('继承人 #{n}', {'n': '${b['inheritor_id']}'})}',
                      ),
