...
CREATE TABLE asset_inheritors (
    ...
    trigger_days INTEGER,           -- 独立触发天数(基于 last_login_at);NULL=沿用全局升级阶梯
...
ALTER TABLE inheritance_events ADD COLUMN asset_id INTEGER REFERENCES assets(id) ON DELETE SET NULL;
