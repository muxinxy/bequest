...
-- 继承绑定引用阶梯(NULL=全局)
ALTER TABLE asset_inheritors ADD COLUMN ladder_id INTEGER REFERENCES trigger_ladders(id) ON DELETE SET NULL;
ALTER TABLE category_inheritors ADD COLUMN ladder_id INTEGER REFERENCES trigger_ladders(id) ON DELETE SET NULL;
